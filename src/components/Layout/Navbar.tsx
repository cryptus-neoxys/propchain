...
export const Navbar: React.FC<NavbarProps> = ({ onConnectWallet, onDisconnectWallet, walletConnected, walletAddress }) => {
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center space-x-2">
            <button
              ...
              title={walletConnected ? 'Disconnect Wallet' : 'Connect Wallet'}
            >
